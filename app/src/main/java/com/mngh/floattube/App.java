...
import com.mngh.floattube.report.AcraReportSenderFactory;
...
public class App extends Application {
    ...
    protected Downloader getDownloader() {
        return com.mngh.floattube.Downloader.init(null);
    }
    ...
    private void initACRA() {
        try {
            ...
            ErrorActivity.reportError(this, ace, null, null, ErrorActivity.ErrorInfo.make(UserAction.SOMETHING_ELSE, "none",
                    "Could not initialize ACRA crash report", com.mngh.floattube.R.string.app_ui_crash));
        }
    }
    ...
    public void initNotificationChannel() {
        ...
        final String id = getString(com.mngh.floattube.R.string.notification_channel_id);
        final CharSequence name = getString(com.mngh.floattube.R.string.notification_channel_name);
        final String description = getString(com.mngh.floattube.R.string.notification_channel_description);
