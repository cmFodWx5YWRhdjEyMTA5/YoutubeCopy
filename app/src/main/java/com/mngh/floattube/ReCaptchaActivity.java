...
public class ReCaptchaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mngh.floattube.R.layout.activity_recaptcha);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(com.mngh.floattube.R.string.reCaptcha_title);
            actionBar.setDisplayShowTitleEnabled(true);
        }

        WebView myWebView = findViewById(com.mngh.floattube.R.id.reCaptchaWebView);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home: {
                Intent intent = new Intent(this, com.mngh.floattube.MainActivity.class);
