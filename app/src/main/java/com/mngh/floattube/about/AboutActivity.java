package com.mngh.floattube.about;
...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mngh.floattube.R.layout.activity_about);

        Toolbar toolbar = findViewById(com.mngh.floattube.R.id.toolbar);
        ...
        mViewPager = findViewById(com.mngh.floattube.R.id.container);
        mViewPager.setAdapter(mSectionsPagerAdapter);

        TabLayout tabLayout = findViewById(com.mngh.floattube.R.id.tabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.mngh.floattube.R.menu.menu_about, menu);
        return true;
    }
    ...
    public static class AboutFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(com.mngh.floattube.R.layout.fragment_about, container, false);
            TextView version = rootView.findViewById(com.mngh.floattube.R.id.app_version);
            version.setText(BuildConfig.VERSION_NAME);

            View githubLink = rootView.findViewById(com.mngh.floattube.R.id.github_link);
            githubLink.setOnClickListener(new OnGithubLinkClickListener());

            View donationLink = rootView.findViewById(com.mngh.floattube.R.id.donation_link);
            donationLink.setOnClickListener(new OnDonationLinkClickListener());

            View websiteLink = rootView.findViewById(com.mngh.floattube.R.id.website_link);
        ...
        private static class OnGithubLinkClickListener implements View.OnClickListener {
            ...
            public void onClick(final View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(context.getString(com.mngh.floattube.R.string.github_url)));
        ...
        private static class OnDonationLinkClickListener implements View.OnClickListener {
            ...
            public void onClick(final View view) {
                final Context context = view.getContext();
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(context.getString(com.mngh.floattube.R.string.donation_url)));
                context.startActivity(intent);
            }
        }
        ...
        private static class OnWebsiteLinkClickListener implements View.OnClickListener {
            ...
            public void onClick(final View view) {
                final Context context = view.getContext();
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(context.getString(com.mngh.floattube.R.string.website_url)));
                context.startActivity(intent);
            }
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(com.mngh.floattube.R.string.tab_about);
                case 1:
                    return getString(com.mngh.floattube.R.string.tab_licenses);
            }
            return null;
        }
    }
