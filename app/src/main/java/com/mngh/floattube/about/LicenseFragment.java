...
public class LicenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(com.mngh.floattube.R.layout.fragment_licenses, container, false);
        ViewGroup softwareComponentsView = rootView.findViewById(com.mngh.floattube.R.id.software_components);

        View licenseLink = rootView.findViewById(com.mngh.floattube.R.id.app_read_license);
        licenseLink.setOnClickListener(new OnReadFullLicenseClickListener());

        for (final SoftwareComponent component : softwareComponents) {
            View componentView = inflater.inflate(com.mngh.floattube.R.layout.item_software_component, container, false);
            TextView softwareName = componentView.findViewById(com.mngh.floattube.R.id.name);
            TextView copyright = componentView.findViewById(com.mngh.floattube.R.id.copyright);
            softwareName.setText(component.getName());
            copyright.setText(getContext().getString(com.mngh.floattube.R.string.copyright,
                    component.getYears(),
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(com.mngh.floattube.R.menu.software_component, menu);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.mngh.floattube.R.id.action_website:
                openWebsite(component.getLink());
                return true;
            case com.mngh.floattube.R.id.action_show_license:
