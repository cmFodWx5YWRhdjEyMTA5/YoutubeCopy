    ...
    public static String getLicenseStylesheet(Context context) {
        ...
        return "body{padding:12px 15px;margin:0;background:#"
                + getHexRGBColor(context, isLightTheme
                    ? com.mngh.floattube.R.color.light_license_background_color
                    : com.mngh.floattube.R.color.dark_license_background_color)
                + ";color:#"
                + getHexRGBColor(context, isLightTheme
                    ? com.mngh.floattube.R.color.light_license_text_color
                    : com.mngh.floattube.R.color.dark_license_text_color) + ";}"
                + "a[href]{color:#"
                + getHexRGBColor(context, isLightTheme
                    ? com.mngh.floattube.R.color.light_youtube_primary_color
                    : com.mngh.floattube.R.color.dark_youtube_primary_color) + ";}"
