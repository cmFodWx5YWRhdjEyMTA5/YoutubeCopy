...
import static com.mngh.floattube.database.history.model.StreamHistoryEntity.STREAM_REPEAT_COUNT;
import static com.mngh.floattube.database.stream.StreamStatisticsEntry.STREAM_LATEST_DATE;
import static com.mngh.floattube.database.stream.StreamStatisticsEntry.STREAM_WATCH_COUNT;
...
import static com.mngh.floattube.database.history.model.StreamHistoryEntity.JOIN_STREAM_ID;
import static com.mngh.floattube.database.history.model.StreamHistoryEntity.STREAM_ACCESS_DATE;
...
public abstract class StreamHistoryDAO implements HistoryDAO<StreamHistoryEntity> {
    ...
    @Query("SELECT * FROM " + StreamEntity.STREAM_TABLE +
            ...
            "  MAX(" + StreamHistoryEntity.STREAM_ACCESS_DATE + ") AS " + STREAM_LATEST_DATE + ", " +
            "  SUM(" + StreamHistoryEntity.STREAM_REPEAT_COUNT + ") AS " + STREAM_WATCH_COUNT +
