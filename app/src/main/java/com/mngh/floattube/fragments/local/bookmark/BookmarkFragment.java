...
import com.mngh.floattube.NewPipeDatabase;
import com.mngh.floattube.database.AppDatabase;
import com.mngh.floattube.database.LocalItem;
import com.mngh.floattube.database.playlist.PlaylistLocalItem;
...
import com.mngh.floattube.fragments.local.LocalPlaylistManager;
import com.mngh.floattube.fragments.local.RemotePlaylistManager;
...
public final class BookmarkFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (activity != null && activity.getSupportActionBar() != null) {
            ...
            activity.setTitle(com.mngh.floattube.R.string.tab_subscriptions);
        }

        return inflater.inflate(com.mngh.floattube.R.layout.fragment_bookmarks, container, false);
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (activity != null && isVisibleToUser) {
            setTitle(activity.getString(com.mngh.floattube.R.string.tab_bookmarks));
        }
    }
    ...
    protected View getListHeader() {
        final View headerRootLayout = activity.getLayoutInflater()
                .inflate(com.mngh.floattube.R.layout.bookmark_header, itemsList, false);
        lastPlayedButton = headerRootLayout.findViewById(com.mngh.floattube.R.id.lastPlayed);
        mostPlayedButton = headerRootLayout.findViewById(com.mngh.floattube.R.id.mostPlayed);
    ...
    protected boolean onError(Throwable exception) {
        ...
        onUnrecoverableError(exception, UserAction.SOMETHING_ELSE,
                "none", "Bookmark", com.mngh.floattube.R.string.general_error);
        return true;
    }
    ...
    private void showDeleteDialog(final String name, final Single<Integer> deleteReactor) {
        ...
        new AlertDialog.Builder(activity)
                .setTitle(name)
                .setMessage(com.mngh.floattube.R.string.delete_playlist_prompt)
                .setCancelable(true)
                .setPositiveButton(com.mngh.floattube.R.string.delete, (dialog, i) ->
                        disposables.add(deleteReactor
                                .observeOn(AndroidSchedulers.mainThread())
                                .subscribe(ignored -> {/*Do nothing on success*/}, this::onError))
                )
                .setNegativeButton(com.mngh.floattube.R.string.cancel, null)
                .show();
    }
