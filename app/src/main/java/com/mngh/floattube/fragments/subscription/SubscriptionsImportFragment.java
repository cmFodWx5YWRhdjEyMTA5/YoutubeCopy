...
import static com.mngh.floattube.subscription.services.SubscriptionsImportService.CHANNEL_URL_MODE;
import static com.mngh.floattube.subscription.services.SubscriptionsImportService.INPUT_STREAM_MODE;
...
public class SubscriptionsImportFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (supportedSources.isEmpty() && currentServiceId != Constants.NO_SERVICE_ID) {
            ErrorActivity.reportError(activity, Collections.emptyList(), null, null, ErrorActivity.ErrorInfo.make(UserAction.SOMETHING_ELSE,
                    NewPipe.getNameOfService(currentServiceId), "Service don't support importing", com.mngh.floattube.R.string.general_error));
            activity.finish();
        }
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            setTitle(getString(com.mngh.floattube.R.string.import_title));
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.mngh.floattube.R.layout.fragment_import, container, false);
    }
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        inputButton = rootView.findViewById(com.mngh.floattube.R.id.input_button);
        inputText = rootView.findViewById(com.mngh.floattube.R.id.input_text);

        infoTextView = rootView.findViewById(com.mngh.floattube.R.id.info_text_view);
        ...
        if (supportedSources.contains(CHANNEL_URL)) {
            inputButton.setText(com.mngh.floattube.R.string.import_title);
            inputText.setVisibility(View.VISIBLE);
            inputText.setHint(ServiceHelper.getImportInstructionsHint(currentServiceId));
        } else {
            inputButton.setText(com.mngh.floattube.R.string.import_file_title);
        }
