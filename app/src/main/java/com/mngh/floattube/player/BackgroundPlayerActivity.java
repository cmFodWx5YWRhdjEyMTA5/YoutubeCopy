...
import static com.mngh.floattube.player.BackgroundPlayer.ACTION_CLOSE;
...
public final class BackgroundPlayerActivity extends ServicePlayerActivity {
    ...
    public String getSupportActionTitle() {
        return getResources().getString(com.mngh.floattube.R.string.title_activity_background_player);
    }
    ...
    public int getPlayerOptionMenuResource() {
        return com.mngh.floattube.R.menu.menu_play_queue_bg;
    }

    @Override
    public boolean onPlayerOptionSelected(MenuItem item) {
        if (item.getItemId() == com.mngh.floattube.R.id.action_switch_popup) {
