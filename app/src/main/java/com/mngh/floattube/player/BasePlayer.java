...
import com.mngh.floattube.player.helper.AudioReactor;
import com.mngh.floattube.player.helper.LoadController;
import com.mngh.floattube.player.helper.MediaSessionManager;
import com.mngh.floattube.player.helper.PlayerDataSource;
import com.mngh.floattube.player.helper.PlayerHelper;
import com.mngh.floattube.player.mediasource.FailedMediaSource;
import com.mngh.floattube.player.playback.BasePlayerMediaSession;
import com.mngh.floattube.player.playback.CustomTrackSelector;
import com.mngh.floattube.player.playback.MediaSourceManager;
import com.mngh.floattube.player.playback.PlaybackListener;
...
import com.mngh.floattube.Downloader;
...
import com.mngh.floattube.playlist.PlayQueueAdapter;
import com.mngh.floattube.playlist.PlayQueueItem;
import com.mngh.floattube.util.SerializedCache;
...
public abstract class BasePlayer implements
    ...
    private void maybeCorrectSeekPosition() {
        ...
        if (recoveryPositionMillis != PlayQueueItem.RECOVERY_UNSET && isCurrentWindowCorrect) {
            ...
            if (DEBUG) Log.d(TAG, "Playback - Rewinding to recovery time=" +
                    "[" + PlayerHelper.getTimeString((int)recoveryPositionMillis) + "]");
    ...
    public void showStreamError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, com.mngh.floattube.R.string.player_stream_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showRecoverableError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, com.mngh.floattube.R.string.player_recoverable_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showUnrecoverableError(Exception exception) {
        ...
        errorToast = Toast.makeText(context, com.mngh.floattube.R.string.player_unrecoverable_failure, Toast.LENGTH_SHORT);
        errorToast.show();
    }
    ...
    public String getVideoUrl() {
        return currentItem == null ? context.getString(com.mngh.floattube.R.string.unknown_content) : currentItem.getUrl();
    }

    public String getVideoTitle() {
        return currentItem == null ? context.getString(com.mngh.floattube.R.string.unknown_content) : currentItem.getTitle();
    }

    public String getUploaderName() {
        return currentItem == null ? context.getString(com.mngh.floattube.R.string.unknown_content) : currentItem.getUploader();
    }
