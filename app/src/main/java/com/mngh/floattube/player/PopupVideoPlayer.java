...
import static com.mngh.floattube.player.BasePlayer.STATE_PLAYING;
...
public final class PopupVideoPlayer extends Service {
    ...
    public static final String ACTION_CLOSE = "com.mngh.floattube.player.PopupVideoPlayer.CLOSE";
    public static final String ACTION_PLAY_PAUSE = "com.mngh.floattube.player.PopupVideoPlayer.PLAY_PAUSE";
    public static final String ACTION_REPEAT = "com.mngh.floattube.player.PopupVideoPlayer.REPEAT";
    ...
    private void initPopup() {
        ...
        View rootView = View.inflate(this, com.mngh.floattube.R.layout.player_popup, null);
        ...
        final float defaultSize = getResources().getDimension(com.mngh.floattube.R.dimen.popup_default_width);
    ...
    private NotificationCompat.Builder createNotification() {
        notRemoteView = new RemoteViews(BuildConfig.APPLICATION_ID, com.mngh.floattube.R.layout.player_popup_notification);

        notRemoteView.setTextViewText(com.mngh.floattube.R.id.notificationSongName, playerImpl.getVideoTitle());
        notRemoteView.setTextViewText(com.mngh.floattube.R.id.notificationArtist, playerImpl.getUploaderName());

        notRemoteView.setOnClickPendingIntent(com.mngh.floattube.R.id.notificationPlayPause,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_PLAY_PAUSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(com.mngh.floattube.R.id.notificationStop,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_CLOSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(com.mngh.floattube.R.id.notificationRepeat,
        ...
        notRemoteView.setOnClickPendingIntent(com.mngh.floattube.R.id.notificationContent,
    ...
    private void updateNotification(int drawableId) {
        ...
        if (drawableId != -1) notRemoteView.setImageViewResource(com.mngh.floattube.R.id.notificationPlayPause, drawableId);
    ...
    private void updateScreenSize() {
        ...
        popupWidth = getResources().getDimension(com.mngh.floattube.R.dimen.popup_default_width);
        popupHeight = getMinimumVideoHeight(popupWidth);

        minimumWidth = getResources().getDimension(com.mngh.floattube.R.dimen.popup_minimum_width);
    ...
    protected void setRepeatModeRemote(final RemoteViews remoteViews, final int repeatMode) {
        ...
        switch (repeatMode) {
            case Player.REPEAT_MODE_OFF:
                remoteViews.setInt(com.mngh.floattube.R.id.notificationRepeat, methodName, com.mngh.floattube.R.drawable.exo_controls_repeat_off);
                break;
            case Player.REPEAT_MODE_ONE:
                remoteViews.setInt(com.mngh.floattube.R.id.notificationRepeat, methodName, com.mngh.floattube.R.drawable.exo_controls_repeat_one);
                break;
            case Player.REPEAT_MODE_ALL:
                remoteViews.setInt(com.mngh.floattube.R.id.notificationRepeat, methodName, com.mngh.floattube.R.drawable.exo_controls_repeat_all);
                break;
        }
    }
    ...
    protected class VideoPlayerImpl extends VideoPlayer implements View.OnLayoutChangeListener {
        ...
        public void initViews(View rootView) {
            ...
            resizingIndicator = rootView.findViewById(com.mngh.floattube.R.id.resizing_indicator);
            fullScreenButton = rootView.findViewById(com.mngh.floattube.R.id.fullScreenButton);
            fullScreenButton.setOnClickListener(v -> onFullScreenButtonClicked());

            extraOptionsView = rootView.findViewById(com.mngh.floattube.R.id.extraOptionsView);
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            ...
            if (loadedImage != null) {
                ...
                if (notRemoteView != null) {
                    notRemoteView.setImageViewBitmap(com.mngh.floattube.R.id.notificationCover, loadedImage);
                }
        ...
        public void onFullScreenButtonClicked() {
            ...
            setRecovery();
            Intent intent;
            if (!PlayerHelper.isUsingOldPlayer(getApplicationContext())) {
        ...
        public void onPaused() {
            super.onPaused();
            updateNotification(com.mngh.floattube.R.drawable.ic_play_arrow_white);
            showAndAnimateControl(com.mngh.floattube.R.drawable.ic_play_arrow_white, false);
        ...
        public void onCompleted() {
            ...
            showAndAnimateControl(com.mngh.floattube.R.drawable.ic_replay_white, false);
            lockManager.releaseWifiAndCpu();
        }
