...
import com.mngh.floattube.fragments.OnScrollBelowItemsListener;
...
import com.mngh.floattube.player.helper.PlaybackParameterDialog;
import com.mngh.floattube.player.helper.PlayerHelper;
import com.mngh.floattube.playlist.PlayQueueAdapter;
import com.mngh.floattube.playlist.PlayQueueItem;
import com.mngh.floattube.playlist.PlayQueueItemBuilder;
import com.mngh.floattube.playlist.PlayQueueItemHolder;
import com.mngh.floattube.playlist.PlayQueueItemTouchCallback;
import com.mngh.floattube.fragments.OnScrollBelowItemsListener;
import com.mngh.floattube.fragments.local.dialog.PlaylistAppendDialog;
import com.mngh.floattube.player.event.PlayerEventListener;
import com.mngh.floattube.player.helper.PlaybackParameterDialog;
...
import static com.mngh.floattube.player.helper.PlayerHelper.formatPitch;
import static com.mngh.floattube.player.helper.PlayerHelper.formatSpeed;
...
public abstract class ServicePlayerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mngh.floattube.R.layout.activity_player_queue_control);
        rootView = findViewById(com.mngh.floattube.R.id.main_content);

        final Toolbar toolbar = rootView.findViewById(com.mngh.floattube.R.id.toolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.mngh.floattube.R.menu.menu_play_queue, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                return true;
            case com.mngh.floattube.R.id.action_append_playlist:
                appendAllToPlaylist();
                return true;
            case com.mngh.floattube.R.id.action_settings:
                NavigationHelper.openSettings(this);
                redraw = true;
                return true;
            case com.mngh.floattube.R.id.action_system_audio:
                startActivity(new Intent(Settings.ACTION_SOUND_SETTINGS));
                return true;
            case com.mngh.floattube.R.id.action_switch_main:
    ...
    private void buildQueue() {
        itemsList = findViewById(com.mngh.floattube.R.id.play_queue);
    ...
    private void buildMetadata() {
        metadata = rootView.findViewById(com.mngh.floattube.R.id.metadata);
        metadataTitle = rootView.findViewById(com.mngh.floattube.R.id.song_name);
        metadataArtist = rootView.findViewById(com.mngh.floattube.R.id.artist_name);
    ...
    private void buildSeekBar() {
        progressCurrentTime = rootView.findViewById(com.mngh.floattube.R.id.current_time);
        progressSeekBar = rootView.findViewById(com.mngh.floattube.R.id.seek_bar);
        progressEndTime = rootView.findViewById(com.mngh.floattube.R.id.end_time);
        progressLiveSync = rootView.findViewById(com.mngh.floattube.R.id.live_sync);
        seekDisplay = rootView.findViewById(com.mngh.floattube.R.id.seek_display);
    ...
    private void buildControls() {
        repeatButton = rootView.findViewById(com.mngh.floattube.R.id.control_repeat);
        backwardButton = rootView.findViewById(com.mngh.floattube.R.id.control_backward);
        playPauseButton = rootView.findViewById(com.mngh.floattube.R.id.control_play_pause);
        forwardButton = rootView.findViewById(com.mngh.floattube.R.id.control_forward);
        shuffleButton = rootView.findViewById(com.mngh.floattube.R.id.control_shuffle);
        playbackSpeedButton = rootView.findViewById(com.mngh.floattube.R.id.control_playback_speed);
        playbackPitchButton = rootView.findViewById(com.mngh.floattube.R.id.control_playback_pitch);
        progressBar = rootView.findViewById(com.mngh.floattube.R.id.control_progress_bar);
    ...
    private void buildItemPopupMenu(final PlayQueueItem item, final View view) {
        ...
        final MenuItem remove = menu.getMenu().add(RECYCLER_ITEM_POPUP_MENU_GROUP_ID, /*pos=*/0,
                Menu.NONE, com.mngh.floattube.R.string.play_queue_remove);
        ...
        final MenuItem detail = menu.getMenu().add(RECYCLER_ITEM_POPUP_MENU_GROUP_ID, /*pos=*/1,
                Menu.NONE, com.mngh.floattube.R.string.play_queue_stream_detail);
        ...
        final MenuItem append = menu.getMenu().add(RECYCLER_ITEM_POPUP_MENU_GROUP_ID, /*pos=*/2,
                Menu.NONE, com.mngh.floattube.R.string.append_playlist);
    ...
    private void onStateChanged(final int state) {
        switch (state) {
            case BasePlayer.STATE_PAUSED:
                playPauseButton.setImageResource(com.mngh.floattube.R.drawable.ic_play_arrow_white);
                break;
            case BasePlayer.STATE_PLAYING:
                playPauseButton.setImageResource(com.mngh.floattube.R.drawable.ic_pause_white);
                break;
            case BasePlayer.STATE_COMPLETED:
                playPauseButton.setImageResource(com.mngh.floattube.R.drawable.ic_replay_white);
                break;
            default:
                break;
        }
    ...
    private void onPlayModeChanged(final int repeatMode, final boolean shuffled) {
        switch (repeatMode) {
            case Player.REPEAT_MODE_OFF:
                repeatButton.setImageResource(com.mngh.floattube.R.drawable.exo_controls_repeat_off);
                break;
            case Player.REPEAT_MODE_ONE:
                repeatButton.setImageResource(com.mngh.floattube.R.drawable.exo_controls_repeat_one);
                break;
            case Player.REPEAT_MODE_ALL:
                repeatButton.setImageResource(com.mngh.floattube.R.drawable.exo_controls_repeat_all);
                break;
        }
    ...
    private void onPlaybackParameterChanged(final PlaybackParameters parameters) {
        if (parameters != null) {
            playbackSpeedButton.setText(PlayerHelper.formatSpeed(parameters.speed));
            playbackPitchButton.setText(PlayerHelper.formatPitch(parameters.pitch));
        }
    }
