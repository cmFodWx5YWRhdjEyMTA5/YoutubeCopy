package com.mngh.floattube.player.playback;
...
import com.mngh.floattube.player.mediasource.LoadedMediaSource;
import com.mngh.floattube.player.mediasource.ManagedMediaSource;
import com.mngh.floattube.player.mediasource.ManagedMediaSourcePlaylist;
import com.mngh.floattube.player.mediasource.PlaceholderMediaSource;
import com.mngh.floattube.playlist.PlayQueue;
import com.mngh.floattube.playlist.PlayQueueItem;
import com.mngh.floattube.playlist.events.MoveEvent;
import com.mngh.floattube.playlist.events.PlayQueueEvent;
import com.mngh.floattube.playlist.events.RemoveEvent;
import com.mngh.floattube.playlist.events.ReorderEvent;
import com.mngh.floattube.player.mediasource.FailedMediaSource;
import com.mngh.floattube.player.mediasource.LoadedMediaSource;
import com.mngh.floattube.player.mediasource.ManagedMediaSource;
import com.mngh.floattube.player.mediasource.ManagedMediaSourcePlaylist;
...
import static com.mngh.floattube.player.mediasource.FailedMediaSource.MediaSourceResolutionException;
import static com.mngh.floattube.player.mediasource.FailedMediaSource.StreamInfoLoadException;
import static com.mngh.floattube.playlist.PlayQueue.DEBUG;
...
public class MediaSourceManager {
    ...
    private void maybeSync() {
        if (PlayQueue.DEBUG) Log.d(TAG, "maybeSync() called.");
    ...
    private Single<ManagedMediaSource> getLoadedMediaSource(@NonNull final PlayQueueItem stream) {
        return stream.getStream().map(streamInfo -> {
            ...
            return new LoadedMediaSource(source, stream, expiration);
                ...
                new FailedMediaSource.StreamInfoLoadException(throwable)));
    }
    ...
    private void maybeClearLoaders() {
        if (PlayQueue.DEBUG) Log.d(TAG, "MediaSource - maybeClearLoaders() called.");
