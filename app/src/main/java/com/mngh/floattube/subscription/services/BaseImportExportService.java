...
import com.mngh.floattube.report.ErrorActivity;
import com.mngh.floattube.report.UserAction;
import com.mngh.floattube.subscription.ImportExportEventListener;
...
public abstract class BaseImportExportService extends Service {
    ...
    protected void stopAndReportError(@Nullable Throwable error, String request) {
        ...
        final ErrorActivity.ErrorInfo errorInfo = ErrorActivity.ErrorInfo.make(UserAction.SUBSCRIPTION, "unknown",
                request, com.mngh.floattube.R.string.general_error);
    ...
    protected void postErrorResult(String title, String text) {
        ...
        text = text == null ? "" : text;
        notificationBuilder = new NotificationCompat.Builder(this, getString(com.mngh.floattube.R.string.notification_channel_id))
    ...
    protected void handleError(@StringRes int errorTitle, @NonNull Throwable error) {
        ...
        if (TextUtils.isEmpty(message)) {
            ...
            message = getString(com.mngh.floattube.R.string.error_occurred_detail, errorClassName);
        }
    ...
    protected String getErrorMessage(Throwable error) {
        ...
        if (error instanceof SubscriptionExtractor.InvalidSourceException) {
            message = getString(com.mngh.floattube.R.string.invalid_source);
        } else if (error instanceof FileNotFoundException) {
            message = getString(com.mngh.floattube.R.string.invalid_file);
        } else if (error instanceof IOException) {
            message = getString(com.mngh.floattube.R.string.network_error);
        }
        return message;
    }
}
