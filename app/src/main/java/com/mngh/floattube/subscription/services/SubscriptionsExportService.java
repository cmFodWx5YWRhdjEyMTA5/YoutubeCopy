...
public class SubscriptionsExportService extends BaseImportExportService {
     ...
     */
    public static final String EXPORT_COMPLETE_ACTION = "com.mngh.floattube.subscription.services.SubscriptionsExportService.EXPORT_COMPLETE";
    ...
    @Override
    public int getTitle() {
        return com.mngh.floattube.R.string.export_ongoing;
    }
    ...
    private void startExport() {
        showToast(com.mngh.floattube.R.string.export_ongoing);
    ...
    private Subscriber<File> getSubscriber() {
        return new Subscriber<File>() {
            ...
            public void onComplete() {
                ...
                showToast(com.mngh.floattube.R.string.export_complete_toast);
                stopService();
            }
        };
    }
    ...
    protected void handleError(Throwable error) {
        super.handleError(com.mngh.floattube.R.string.subscriptions_export_unsuccessful, error);
    }
}
