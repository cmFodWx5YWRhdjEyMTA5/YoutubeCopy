    ...
    public static void handleGeneralException(Context context, int serviceId, String url, Throwable exception, UserAction userAction, String optionalErrorMessage) {
        ...
        handler.post(() -> {
            if (exception instanceof ReCaptchaException) {
                Toast.makeText(context, com.mngh.floattube.R.string.recaptcha_request_toast, Toast.LENGTH_LONG).show();
                // Starting ReCaptcha Challenge Activity
                Intent intent = new Intent(context, ReCaptchaActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(intent);
            } else if (exception instanceof IOException) {
                Toast.makeText(context, com.mngh.floattube.R.string.network_error, Toast.LENGTH_LONG).show();
            } else if (exception instanceof YoutubeStreamExtractor.GemaException) {
                Toast.makeText(context, com.mngh.floattube.R.string.blocked_by_gema, Toast.LENGTH_LONG).show();
            } else if (exception instanceof ContentNotAvailableException) {
                Toast.makeText(context, com.mngh.floattube.R.string.content_not_available, Toast.LENGTH_LONG).show();
            } else {
                int errorId = exception instanceof YoutubeStreamExtractor.DecryptException ? com.mngh.floattube.R.string.youtube_signature_decryption_error :
                        exception instanceof ParsingException ? com.mngh.floattube.R.string.parsing_error : com.mngh.floattube.R.string.general_error;
