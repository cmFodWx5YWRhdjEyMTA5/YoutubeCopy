...
public class FilePickerActivityHelper extends com.nononsenseapps.filepicker.FilePickerActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        if(ThemeHelper.isLightThemeSelected(this)) {
            this.setTheme(com.mngh.floattube.R.style.FilePickerThemeLight);
        } else {
            this.setTheme(com.mngh.floattube.R.style.FilePickerThemeDark);
        }
    ...
    public static class CustomFilePickerFragment extends FilePickerFragment {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            if (view instanceof TextView) {
                ((TextView) view).setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(com.mngh.floattube.R.dimen.file_picker_items_text_size));
            }
        ...
        public void onClickOk(@NonNull View view) {
            if (mode == MODE_NEW_FILE && getNewFileName().isEmpty()) {
                ...
                mToast = Toast.makeText(getActivity(), com.mngh.floattube.R.string.file_name_empty_error, Toast.LENGTH_SHORT);
                mToast.show();
                return;
            }
