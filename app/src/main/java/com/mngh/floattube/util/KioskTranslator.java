...
public class KioskTranslator {
    public static String getTranslatedKioskName(String kioskId, Context c) {
        switch(kioskId) {
            case "Trending":
                return c.getString(com.mngh.floattube.R.string.trending);
            case "Top 50":
                return c.getString(com.mngh.floattube.R.string.top_50);
            case "New & hot":
                return c.getString(com.mngh.floattube.R.string.new_and_hot);
            default:
                return kioskId;
        }
    }
