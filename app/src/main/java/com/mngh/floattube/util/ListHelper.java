...
public final class ListHelper {
    ...
    public static int getDefaultResolutionIndex(Context context, List<VideoStream> videoStreams) {
        ...
        String defaultResolution = defaultPreferences.getString(context.getString(com.mngh.floattube.R.string.default_resolution_key), context.getString(com.mngh.floattube.R.string.default_resolution_value));
    ...
    public static int getPopupDefaultResolutionIndex(Context context, List<VideoStream> videoStreams) {
        ...
        String defaultResolution = defaultPreferences.getString(context.getString(com.mngh.floattube.R.string.default_popup_resolution_key), context.getString(com.mngh.floattube.R.string.default_popup_resolution_value));
    ...
    public static int getDefaultAudioFormat(Context context, List<AudioStream> audioStreams) {
        MediaFormat defaultFormat = getDefaultFormat(context, com.mngh.floattube.R.string.default_audio_format_key, com.mngh.floattube.R.string.default_audio_format_value);
    ...
    public static List<VideoStream> getSortedStreamVideosList(Context context, List<VideoStream> videoStreams, List<VideoStream> videoOnlyStreams, boolean ascendingOrder) {
        ...
        boolean showHigherResolutions = preferences.getBoolean(context.getString(com.mngh.floattube.R.string.show_higher_resolutions_key), false);
        MediaFormat defaultFormat = getDefaultFormat(context, com.mngh.floattube.R.string.default_video_format_key, com.mngh.floattube.R.string.default_video_format_value);
    ...
    private static int getDefaultResolutionWithDefaultFormat(Context context, String defaultResolution, List<VideoStream> videoStreams) {
        MediaFormat defaultFormat = getDefaultFormat(context, com.mngh.floattube.R.string.default_video_format_key, com.mngh.floattube.R.string.default_video_format_value);
        return getDefaultResolutionIndex(defaultResolution, context.getString(com.mngh.floattube.R.string.best_resolution_key), defaultFormat, videoStreams);
    }
    ...
    private static MediaFormat getMediaFormatFromKey(Context context, String formatKey) {
        ...
        if (formatKey.equals(context.getString(com.mngh.floattube.R.string.video_webm_key))) {
            format = MediaFormat.WEBM;
        } else if (formatKey.equals(context.getString(com.mngh.floattube.R.string.video_mp4_key))) {
            format = MediaFormat.MPEG_4;
        } else if (formatKey.equals(context.getString(com.mngh.floattube.R.string.video_3gp_key))) {
            format = MediaFormat.v3GPP;
        } else if (formatKey.equals(context.getString(com.mngh.floattube.R.string.audio_webm_key))) {
            format = MediaFormat.WEBMA;
        } else if (formatKey.equals(context.getString(com.mngh.floattube.R.string.audio_m4a_key))) {
