...
public class Localization {
    ...
    public static Locale getPreferredLocale(Context context) {
        ...
        String languageCode = sp.getString(context.getString(com.mngh.floattube.R.string.search_language_key), context.getString(com.mngh.floattube.R.string.default_language_value));
    ...
    public static String localizeDate(Context context, String date) {
        ...
        String dateString = res.getString(com.mngh.floattube.R.string.upload_date_text);
    ...
    public static String localizeViewCount(Context context, long viewCount) {
        return getQuantity(context, com.mngh.floattube.R.plurals.views, com.mngh.floattube.R.string.no_views, viewCount, localizeNumber(context, viewCount));
    }

    public static String localizeSubscribersCount(Context context, long subscriberCount) {
        return getQuantity(context, com.mngh.floattube.R.plurals.subscribers, com.mngh.floattube.R.string.no_subscribers, subscriberCount, localizeNumber(context, subscriberCount));
    }

    public static String localizeStreamCount(Context context, long streamCount) {
        return getQuantity(context, com.mngh.floattube.R.plurals.videos, com.mngh.floattube.R.string.no_videos, streamCount, localizeNumber(context, streamCount));
    }

    public static String shortCount(Context context, long count) {
        if (count >= 1000000000) {
            return Long.toString(count / 1000000000) + context.getString(com.mngh.floattube.R.string.short_billion);
        } else if (count >= 1000000) {
            return Long.toString(count / 1000000) + context.getString(com.mngh.floattube.R.string.short_million);
        } else if (count >= 1000) {
            return Long.toString(count / 1000) + context.getString(com.mngh.floattube.R.string.short_thousand);
        } else {
    ...
    public static String shortViewCount(Context context, long viewCount) {
        return getQuantity(context, com.mngh.floattube.R.plurals.views, com.mngh.floattube.R.string.no_views, viewCount, shortCount(context, viewCount));
    }

    public static String shortSubscriberCount(Context context, long subscriberCount) {
        return getQuantity(context, com.mngh.floattube.R.plurals.subscribers, com.mngh.floattube.R.string.no_subscribers, subscriberCount, shortCount(context, subscriberCount));
    }
