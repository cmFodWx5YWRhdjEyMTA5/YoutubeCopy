...
public class ServiceHelper {
    ...
    public static int getIcon(int serviceId) {
        switch (serviceId) {
            case 0:
                return com.mngh.floattube.R.drawable.place_holder_youtube;
            case 1:
                return com.mngh.floattube.R.drawable.place_holder_circle;
            default:
                return com.mngh.floattube.R.drawable.service;
        }
    }
    ...
    public static int getImportInstructions(int serviceId) {
        switch (serviceId) {
            case 0:
                return com.mngh.floattube.R.string.import_youtube_instructions;
            case 1:
                return com.mngh.floattube.R.string.import_soundcloud_instructions;
            default:
                return -1;
        }
    }
    ...
    public static int getImportInstructionsHint(int serviceId) {
        switch (serviceId) {
            case 1:
                return com.mngh.floattube.R.string.import_soundcloud_instructions_hint;
            default:
                return -1;
        }
    }
    ...
    public static int getSelectedServiceId(Context context) {
        ...
        final String serviceName = PreferenceManager.getDefaultSharedPreferences(context)
                .getString(context.getString(com.mngh.floattube.R.string.current_service_key), context.getString(com.mngh.floattube.R.string.default_service_value));
    ...
    private static void setSelectedServicePreferences(Context context, String serviceName) {
        PreferenceManager.getDefaultSharedPreferences(context).edit().
                putString(context.getString(com.mngh.floattube.R.string.current_service_key), serviceName).apply();
    }
