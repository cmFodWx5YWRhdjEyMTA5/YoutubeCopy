...
public class ThemeHelper {
    ...
    public static boolean isLightThemeSelected(Context context) {
        return getSelectedThemeString(context).equals(context.getResources().getString(com.mngh.floattube.R.string.light_theme_key));
    }
    ...
    public static int getDialogTheme(Context context) {
        return isLightThemeSelected(context) ? com.mngh.floattube.R.style.LightDialogTheme : com.mngh.floattube.R.style.DarkDialogTheme;
    }
    ...
    public static int getThemeForService(Context context, int serviceId) {
        String lightTheme = context.getResources().getString(com.mngh.floattube.R.string.light_theme_key);
        String darkTheme = context.getResources().getString(com.mngh.floattube.R.string.dark_theme_key);
        String blackTheme = context.getResources().getString(com.mngh.floattube.R.string.black_theme_key);

        String selectedTheme = getSelectedThemeString(context);

        int defaultTheme = com.mngh.floattube.R.style.DarkTheme;
        if (selectedTheme.equals(lightTheme)) defaultTheme = com.mngh.floattube.R.style.LightTheme;
        else if (selectedTheme.equals(blackTheme)) defaultTheme = com.mngh.floattube.R.style.BlackTheme;
        else if (selectedTheme.equals(darkTheme)) defaultTheme = com.mngh.floattube.R.style.DarkTheme;
    ...
    public static int getSettingsThemeStyle(Context context) {
        ...
        if (selectedTheme.equals(lightTheme)) return com.mngh.floattube.R.style.LightSettingsTheme;
        else if (selectedTheme.equals(blackTheme)) return com.mngh.floattube.R.style.BlackSettingsTheme;
        else if (selectedTheme.equals(darkTheme)) return com.mngh.floattube.R.style.DarkSettingsTheme;
            // Fallback
        else return com.mngh.floattube.R.style.DarkSettingsTheme;
    }
    ...
    private static String getSelectedThemeString(Context context) {
        String themeKey = context.getString(com.mngh.floattube.R.string.theme_key);
        String defaultTheme = context.getResources().getString(com.mngh.floattube.R.string.default_theme_value);
